            ...
            <div className="mt-8 pt-6 border-t border-pitch-700">
              ...
              <div className="space-y-3">
                {[
                  ...
                  ["🏆", "Grup Sıralaması", "Her gruptan ilk 2'ye çıkacak takımları sıralı tahmin et. İkisini birden doğru bilirsen 10 puan."],
                  ...
                  ["🏅", "Kupayı Kim Kazanır", "Şampiyonu ve finalisti tahmin et. Doğru şampiyon 20 puan, iki finalisti birden bilirsen 10 puan."],
              ...
              <div className="mt-4 text-center text-[13px] text-slate-500">
                🎯 Maç = 3 puan &nbsp;•&nbsp; 📊 Alt/Üst = 1 puan &nbsp;•&nbsp; 🏆 Sıralama = 10 puan
              </div>
            </div>
          </div>
        )}
